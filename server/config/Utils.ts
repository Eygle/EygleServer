...
class Utils {
   ...
   /**
    * Last CGU update date
    * Every user who did not accepted the last CGU will have to
    */
   public static lastCGUUpdateDate: Date;
   ...
   /**
    * Socket.io authentication secret
    */
   public static jwtSecret: string;

   /**
    * Socket.io authentication life duration
    */
   public static jwtExpireIn: string;
   ...
   /**
    * MaPUI user hash used to identify user in urls
    */
   ...
   /**
    * Object with theriaque connection options
    */
   public static theriaqueOptions: any;
   ...
   public static init(): void {
      ...
      this.appName = process.env.NODE_APP || 'mapui';
      this.port = this.env === EEnv.Preprod ? 4746 : 4646;
      this.dbName = this.env === EEnv.Preprod ? 'mapuiv3preprod' : 'mapuiv3';

      this.debug = false;

      this.root = path.normalize(`${__dirname}/../..`);
      this.clientRoot = `${this.root}/client`;
      this.lastCGUUpdateDate = new Date("Fri Jan 01 2016 00:00:00 GMT+0200 (CEST)");
      ...
      this.jwtSecret = 'EygleJWTSECRET';
      this.jwtExpireIn = '48 hours';
      this.sessionSecret = 'MySecretEygleblabla436zqedsfrdglkflesqkd=q!';
